...
export default function StorefrontCheckout({ business, pages, hasPaystack, hasJunipay, addresses }: Props) {
    ...
    return (
        <Suspense fallback={null}>
            ...
            <Checkout business={business} pages={pages} hasPayment={hasPaystack || hasJunipay} addresses={addresses} />
        </Suspense>
    );
}
