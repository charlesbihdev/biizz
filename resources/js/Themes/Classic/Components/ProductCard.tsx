...
export default function ProductCard({ product, onAddToCart, accentColor, primaryColor, isDigital }: Props) {
    ...
    const textMuted  = primary + 'b3'; // 70% opacity — descriptions, meta
    const textSubtle = primary + '73'; // 45% opacity — category label
    ...
    return (
        <div className="group flex flex-col overflow-hidden rounded-2xl border border-zinc-100 bg-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
